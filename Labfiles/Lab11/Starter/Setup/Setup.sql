...
MOVE N'AdventureWorks2016CTP3_Data' TO N'$(SUBDIR)Setup\AdventureWorks_Data.mdf', 
MOVE N'AdventureWorks2016CTP3_Log' TO N'$(SUBDIR)Setup\AdventureWorks_log.ldf',
MOVE N'AdventureWorks2016CTP3_mod' TO N'$(SUBDIR)Setup\AdventureWorks_mod'
GO
