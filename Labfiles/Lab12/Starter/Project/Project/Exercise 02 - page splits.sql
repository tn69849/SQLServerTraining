...
SELECT xe_node.value('', 'bigint') AS alloc_unit_id,
       xe_node.value('', 'bigint') AS split_count
...
CROSS APPLY target_data.nodes('') AS xe_xml (xe_node); 
